...
public class CourseController {
    ...
    @PostMapping("/add")
    public CourseEntity addCourse(@RequestBody CourseModel courseModel) {
        return courseService.save(courseMapper.convertToEntity(courseModel));
    }

    @PutMapping("/update")
    public CourseEntity updateCourse(@RequestBody CourseModel courseModel) {
        return courseService.update(courseMapper.convertToEntity(courseModel));
    }
